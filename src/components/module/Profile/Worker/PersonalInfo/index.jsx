...
const PersonalInformation = ({ activeUser, skills }) => {
   const navigate = useNavigate();
   const role = compareBcrypt("worker");
   return (
      <div className="bg-white flex flex-col items-center lg:items-start md:h-[700px] lg:h-[800px] w-full lg:w-[357px] rounded lg:px-5 py-4">
